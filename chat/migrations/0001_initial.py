    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='chat.user')),
                ('participants', models.ManyToManyField(blank=True, related_name='participants', to='chat.user')),
            ],
            options={
